...
function start(){
	...
	alert("RÈGLES : cliquez sur le bon chiffre qui indique le nombre d'éléments affichés")
	display()
}
...
function display(){
	document.getElementById("stage").innerHTML="Niveau: <span class=\"blue\">"+level+"</span> Stage :<span <span class=\"blue\">"+stage+"</span>"
	document.getElementById("try").innerHTML=" Chance: <span <span class=\"blue\">"+chance+"</span>"
	if(stage<2){
...
function cmp(var1,var2,e){
	if(var1===var2){
		...
		audio.play()
		document.getElementById("stage").innerHTML="Niveau: <span class=\"blue\">"+level+"</span> Stage :<span <span class=\"blue\">"+stage+"</span>"
		document.getElementById("try").innerHTML=" Chance: <span class=\"blue\">"+chance+"</span>"
		e.style.color="green"
		document.getElementById("displayImg").innerHTML=""
		if(level===3){
			stage=stage+1;
		...
		if(stage>=3 && chance>0){
			...
			alert("you win !!!")
			document.getElementById("displayImg").innerHTML=""
			newtext2=document.createTextNode("FÉLICITATIONS vous avez sauvé le royaume")
		...
		if(chance<=0 && stage<3){
			...
			document.getElementById("displayImg").innerHTML=""
			newp2=document.createElement('p');
			newtext2=document.createTextNode("OHHH !! Vous avez échoué à protéger le royaume")
			newp2.appendChild(newtext2)
...
function aler(){
	alert("\t\t 1-Ne redimensionnez pas la page\n\t\t2-Autorisez la lecture automatique sur votre ordinateur pour profiter pleinement du jeu")
